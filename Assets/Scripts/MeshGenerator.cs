...
public static class MeshGenerator
{
    ...
    {
        AnimationCurve heightCure = new AnimationCurve(_heightCurve.keys);
        ...
        for (int y = 0; y < height; y += meshSimplificationIncrement)
        {
            ...
            {
                meshData.vertices[vertexIndex] = new Vector3(topLeftX + x, heightCure.Evaluate(heightMap[x, y]) * heightMultiplier, topLeftZ - y);
